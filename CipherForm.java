...
// and returns the original text
    ...
    private void decrypt1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        key = key.toUpperCase();
        //String ciphertext = "";
        String ciphertext = encrypt(plaintext1, key);
        String expectedValue = key;
        String plaintextValue = plaintext1;
        String decryptedText = decrypt(ciphertext, key);

        if(plaintext1.isEmpty()){
            JOptionPane.showMessageDialog(this, "PLAIN TEXT CANNOT BE EMPTY", "WARNING", JOptionPane.WARNING_MESSAGE);
        }else if(!plaintext1.equals(plaintextValue)){
            JOptionPane.showMessageDialog(this, "PLAIN TEXT NOT MATCH", "WARNING", JOptionPane.WARNING_MESSAGE);
        }


        //encrypt1.setEnabled(true);

        if (key.isEmpty()) {
            JOptionPane.showMessageDialog(this, "KEY CANNOT BE EMPTY", "WARNING", JOptionPane.WARNING_MESSAGE);
        } else if (!key.equals(expectedValue)) {
            JOptionPane.showMessageDialog(this, "KEY MUST EQUAL TO THE KEY", "WARNING", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    private void dencrypt2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String plaintextValue1 = plaintext2;
        String expectedValue1 = keyword2;


        if (isInteger(keyword2)) {
            int numericKey = Integer.parseInt(keyword2);
            keyword2 = "" + alphabet.charAt(numericKey % 26);
            enc = autoEncryption(plaintext2, keyword2);
        } else {
            enc = autoEncryption(plaintext2, keyword2);
        }
        ...
        if(plaintext2.isEmpty()){
            JOptionPane.showMessageDialog(this, "PLAIN TEXT CANNOT BE EMPTY", "WARNING", JOptionPane.WARNING_MESSAGE);
        }else if(!plaintext2.equals(plaintextValue1)){
            JOptionPane.showMessageDialog(this, "PLAIN TEXT NOT MATCH", "WARNING", JOptionPane.WARNING_MESSAGE);
        }
        ...
        if (keyword2.isEmpty()) {
            JOptionPane.showMessageDialog(this, "KEY CANNOT BE EMPTY", "WARNING", JOptionPane.WARNING_MESSAGE);
        } else if (!keyword2.equals(keyword2)) {
            JOptionPane.showMessageDialog(this, "KEY MUST EQUAL TO THE KEY", "WARNING", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    private void decrypt3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String plaintextValue2 = plaintext3;
    ...
    private void encrypt3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String expectedValue2 = keyword;
        String plaintextValue2 = str;
        ...
        if(cipher_text.isEmpty()){
            JOptionPane.showMessageDialog(this, "PLAIN TEXT CANNOT BE EMPTY", "WARNING", JOptionPane.WARNING_MESSAGE);
        }else if(!cipher_text.equals(cipher_text)){
            JOptionPane.showMessageDialog(this, "PLAIN TEXT NOT MATCH", "WARNING", JOptionPane.WARNING_MESSAGE);
        }
    ...
    //poly-alphabetic cipher logic..
    public static String autoEncryption(String plaintext2, String keyword2){
        int len = plaintext2.length();

        // generating the key-stream
        String newKey = keyword2.concat(plaintext2);
        newKey = newKey.substring(0, newKey.length() - keyword2.length());
        String encryptMsg = "";
